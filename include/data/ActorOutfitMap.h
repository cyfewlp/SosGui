...
public:
    ...
    auto GetOutfitId(RE::Actor *actor) const -> OutfitId { return m_container.contains(actor) ? m_container.at(actor) : INVALID_OUTFIT_ID; }

    auto HasActiveOutfit(RE::Actor *actor) const -> bool { return m_container.contains(actor); }
