...
namespace LIBC_NAMESPACE_DECL
{
    ...
    void Setting::UiSettingReadLineFn(ImGuiContext * /*ctx*/, ImGuiSettingsHandler * /*handler*/, void *entry,
                                      const char *line)
    {
    ...
    void Setting::UiSettingWriteAll([[maybe_unused]] ImGuiContext *ctx, ImGuiSettingsHandler *handler,
                                    ImGuiTextBuffer *buf)
    {
    ...
    void Setting::UiSettingApplyAll(ImGuiContext * /*ctx*/, ImGuiSettingsHandler * /*handler*/)
    {
        ...
        if (ImThemeLoader::Loader::IsIndexInRange(setting->selectedThemeIndex))
        {
            ImThemeLoader::Loader::UseTheme(setting->selectedThemeIndex);
        }
    }
